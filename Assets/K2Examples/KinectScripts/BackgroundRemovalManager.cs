...
public class BackgroundRemovalManager : MonoBehaviour
{
	...
	[Tooltip("RenderTexture to render the foreground image.")]
	...
	void Update()
	{
		if (isBrInited)
		{
			...
			if (foregroundTexture != null)
			{
				...
				KinectInterop.TransformTexture(GetForegroundTex(), foregroundTexture, 0, imageScale.x < 0f, imageScale.y < 0f, foregroundCamera == null);
			}
		}
	}
	...
	void OnGUI()
	{
		if (isBrInited && foregroundTexture == null)
		{
